...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        // Tidak perlu load WorkSchedule karena input jam sekarang manual/langsung
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            // Validasi Jam Kerja (Nullable = Boleh Kosong/Fleksibel)
        ...
        // Ambil input kecuali yang perlu diproses manual
        $data = $request->except(['password', 'profile_photo_path', 'multi_branches', 'multi_divisions']);

        // LOGIKA JAM KERJA:
        // Input time HTML jika kosong mengirim string "", kita ubah jadi NULL agar database tahu ini "Fleksibel"
    ...
    public function update(Request $request, User $user)
    {
        ...
        // Jika form kosong (""), ubah jadi null untuk database
        $data['check_in_start'] = $request->check_in_start ?: null;
        $data['check_in_end']   = $request->check_in_end ?: null;
        $data['check_out_start'] = $request->check_out_start ?: null;
        $data['check_out_end']  = $request->check_out_end ?: null;
    ...
    public function show(User $user)
    {
        ...
        // Load relasi (WorkSchedule dihapus dari load karena sudah pakai direct column)
