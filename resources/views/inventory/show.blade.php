                ...
                <div class="card-body text-center">
                    ...
                    @if ($inventory->item_photo_path)
                        <img src="{{ asset('storage/' . $inventory->item_photo_path) }}"
                            class="img-fluid rounded mb-3 shadow-sm" alt="Foto Barang"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="bg-light p-3 rounded h-100">
                                ...
                                <span
                                    class="fw-bold fs-5">{{ ucfirst(str_replace('_', ' ', $inventory->condition)) }}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-light p-3 rounded h-100">
                                ...
                                <span
                                    class="fw-bold fs-5">{{ \Carbon\Carbon::parse($inventory->received_date)->translatedFormat('d F Y') }}</span>
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="mb-4">
                        ...
                        @else
                            <span class="text-small text-muted fst-italic">Tidak ada dokumen (Faktur/Garansi)
                                terlampir.</span>
                        @endif
                    </div>
