...
@push('styles')
    <style>
        ...
        .inventory-list-group {
            ...
            margin: 0;
            flex-grow: 1;
            /* Supaya tombol detail terdorong ke bawah jika konten sedikit */
        }
        ...
        @forelse ($branches as $branch)
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="branch-card-item p-4">
                    ...
                    <div class="mb-3">
                        <h6 class="text-uppercase text-muted" style="font-size: 0.7rem; letter-spacing: 0.5px;">Rincian
                            Aset:</h6>
                        ...
                        <ul class="inventory-list-group">
                            ...
                            @if ($branch->inventory_summary->count() > 4)
                                <li class="inventory-list-item justify-content-center text-primary"
                    ...
                    <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('inventory.branch.detail', $branch->id) }}"
