                ...
                <form class="forms-sample" action="{{ route('inventory.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @if($fixedUser)
                            ...
                            <input type="text" class="form-control bg-light" value="{{ $fixedUser->name }} - {{ $fixedUser->branch->name ?? 'Non-Cabang' }}" readonly>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="serial_number" class="form-control" placeholder="Opsional" value="{{ old('serial_number') }}">
                        </div>
                        <div class="col-md-6 form-group">
