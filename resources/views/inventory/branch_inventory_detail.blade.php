                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <span class="badge bg-light text-secondary border d-flex align-items-center">Total:
                                {{ $inventories->count() }}</span>
                        </div>
                    </div>
                                                ...
                                                <div class="text-center">
                                                    @if($item->item_photo_path)
                                                        <img src="{{ asset('storage/' . $item->item_photo_path) }}"
                                                            class="cursor-pointer" title="Klik untuk memperbesar (Fisik Barang)"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-bold" style="font-size: 0.9rem;">
                                                        {{ $item->user->name ?? 'Tanpa Pemilik' }}</div>
                                                    <small class="text-muted"
                                                        style="font-size: 0.75rem;">{{ $item->user->division->name ?? '-' }}</small>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-5 text-muted">
                                            <div class="d-flex flex-column align-items-center">
                                                <i class="mdi mdi-package-variant-closed text-secondary opacity-25"
