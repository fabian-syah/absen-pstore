...
@section('content')
{{-- Custom Style untuk Tampilan Profesional --}}
<style>
    ...
    .form-control:focus { box-shadow: none; border-color: #4B49AC; }
    ...
    .bg-privilege { background-color: #f0fdf4; border: 1px solid #bbf7d0; } /* Hijau muda halus */
</style>
        ...
        <div class="card shadow-sm border-0 rounded-4">
            ...
            <div class="card-header-clean d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0 small">Atur komponen gaji untuk: <strong>{{ $user->name }}</strong> ({{ $user->branch->name ?? 'No Branch' }})</p>
                </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('employee-salaries.update', $user->id) }}" method="POST" id="salaryForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 border-end">
                            <div class="mb-4">
                                ...
                                <div class="p-3 bg-light rounded-3 border">
                                    <label class="form-label text-muted mb-2">Informasi Rekening</label>
                                    <div class="mb-2">
                        ...
                        {{-- KOLOM KANAN: FORM NOMINAL (DINAMIS) --}}
                        <div class="col-md-7">
                            ...
                            <div id="form_employee" class="salary-section">
                                ...
                                {{-- FITUR PRIVILEGE (AUTO BEBAS POTONGAN) --}}
                                <div class="p-3 bg-privilege rounded-3">
                                    <div class="form-check form-switch">
                                        {{-- Pastikan kolom 'use_privilege_mode' ada di database, jika belum ada, pakai logic lain atau tambah kolom --}}
                                        ...
                                        <label class="form-check-label fw-bold text-success" for="privilegeSwitch">
                                            Aktifkan Mode Privilege
                                        </label>
                                    </div>
                                    <p class="mb-0 mt-1 small text-muted lh-sm">
                                        <i class="mdi mdi-shield-check"></i> Jika aktif, karyawan ini <strong>tidak akan terkena potongan</strong> (Alpha/Telat) secara otomatis saat Payroll.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div id="form_promotor" class="salary-section" style="display: none;">
                                ...
                                <div class="alert alert-info py-2 small">
                                    <i class="mdi mdi-information-outline"></i> Kategori ini hanya menerima <strong>Bonus / Insentif</strong>.
                                </div>
                                
                                {{-- Hidden Basic Salary (0) --}}
                                <input type="hidden" name="promotor_monthly_salary" value="0">

                                <div class="mb-3">
                                    <label class="form-label">Insentif / Bonus (Estimasi Bulanan)</label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                    ...
                                    <div class="form-text">Angka ini akan muncul otomatis saat Payroll (bisa diedit).</div>
                                </div>
                            </div>
                            ...
                            <div id="form_freelance" class="salary-section" style="display: none;">
                                ...
                                <div class="alert alert-warning py-2 small">
                                    <i class="mdi mdi-information-outline"></i> Pembayaran dihitung <strong>Harian</strong> (No Work No Pay).
                                </div>
