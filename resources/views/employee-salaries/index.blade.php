                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pe-4">
                                        <a href="{{ route('employee-salaries.edit', $user->id) }}" class="btn btn-outline-primary btn-sm fw-bold px-3 py-2 d-inline-flex align-items-center gap-2" style="border-radius: 8px; border-width: 2px;">
