                            ...
                            <tbody>
                                @forelse($violations as $v)
                                    <tr>
                                        ...
                                        <td>
                                            @if($v->photo_path)
                                                <img src="{{ asset('storage/' . $v->photo_path) }}" alt="Bukti"
                                                    class="img-thumbnail"
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small class="text-muted">({{ now()->diffInDays($v->expires_at) }} hari
                                                lagi)</small>
                                        </td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="{{ route('violations.edit', $v->id) }}"
                                                        class="btn btn-warning btn-sm icon-btn p-2 mr-1" title="Edit">
                                                    ...
                                                    <form action="{{ route('violations.destroy', $v->id) }}" method="POST"
                                                        class="d-inline" onsubmit="return confirm('Hapus permanen data ini?')">
                                                        @csrf
                                                        @method('DELETE')
                ...
                <form id="resolveForm" method="POST" action="">
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal"
                            onclick="$('#resolveModal').modal('hide')">&times;</button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea name="resolution_notes" class="form-control" rows="3" required
                                placeholder="Contoh: Sudah ditebus lembur, Dimaafkan HRD, Salah input, dll..."></textarea>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            onclick="$('#resolveModal').modal('hide')">Batal</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    ...
                    <button type="button" class="close" data-dismiss="modal"
                        onclick="$('#imagePreviewModal').modal('hide')">&times;</button>
                </div>
