        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3">
                ...
                @else
                    ...
                    <div class="card border-0 shadow-sm text-white h-100 rounded-4 overflow-hidden"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0 ps-0"
                                        placeholder="Nama karyawan / Ket..." value="{{ request('search') }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <tbody>
                                @forelse($kasbons as $k)
                                    ...
                                    <tr>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="small text-muted d-flex align-items-center mt-1">
                                                        ...
                                                        <span class="text-truncate"
                                                            style="max-width: 120px;">{{ $branchName }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <h6 class="mb-0 fw-bold text-dark">Rp {{ number_format($k->amount, 0, ',', '.') }}
                                            </h6>
                                        </td>
                                            ...
                                            @if($k->amount > 0 && $k->remaining_amount > 0)
                                                <div class="d-flex align-items-center justify-content-end mt-1">
                                                    ...
                                                    <span class="ms-2 small text-muted"
                                                        style="font-size: 10px;">{{ number_format($percent, 0) }}%</span>
                                                </div>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center">
                                            @if($k->status == 'pending')
                                                <span
                                                    class="badge rounded-pill bg-warning text-dark px-3 py-2 fw-bold border border-warning">
                                                    <i class="mdi mdi-timer-sand me-1"></i> MENUNGGU
                                                </span>
                                            @elseif($k->status == 'approved')
                                                <span
                                                    class="badge rounded-pill bg-white text-primary px-3 py-2 fw-bold border border-primary shadow-sm">
