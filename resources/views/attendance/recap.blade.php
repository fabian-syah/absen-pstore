...
<head>
    ...
    <style>
        ...
        .slide {
            ...
            pointer-events: none; /* Klik tembus ke navigasi */
        }
        ...
        /* Buttons & Links (Z-Index Tinggi agar bisa diklik) */
        .action-btn {
        ...
        /* Area Capture yang akan didownload */
        #capture-area {
            width: 100%; height: 100%; display: flex;
            flex-direction: column; justify-content: center; align-items: center;
            /* Background Texture untuk hasil download */
    ...
    <script>
        ...
        function downloadImage() {
            ...
            html2canvas(element, { 
                ...
                btn.innerHTML = '<i class="mdi mdi-alert"></i> Gagal';
            });
        }
    </script>
</body>
