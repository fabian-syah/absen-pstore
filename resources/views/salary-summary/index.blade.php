        ...
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-3 text-info">
                    ...
                    Ringkasan Milik: <span class="fw-bold text-dark">{{ $targetUser->name }}</span>
                </h5>
                        ...
                        <tbody>
                            @foreach($summary as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($item['data'])
                                            <a href="{{ route('salaries.show', $item['data']->id) }}" class="btn btn-sm btn-outline-info">
                                                Detail
                                            </a>
                                        @endif
                                    </td>
                            ...
                            <tr class="table-warning fw-bold">
                                ...
                                <td class="text-end text-black fs-5">Rp {{ number_format($totalAnnual, 0, ',', '.') }}</td>
                                <td colspan="2"></td>
                            </tr>
                        </tbody>
                    </table>
