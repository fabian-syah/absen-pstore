                    ...
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="py-3 text-muted fw-semibold text-center" style="width: 140px;">TOTAL PERSONEL</th>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="d-block fw-semibold text-dark mb-1">{{ $division->name }}</span>
                                    ...
                                    <td class="text-center">
                                        <div class="personel-count-wrapper">
                                            @if($division->users_count > 0)
                                                <div class="personel-badge bg-success bg-opacity-10 border border-success border-opacity-25 rounded-3 px-3 py-2 d-inline-flex align-items-center">
                                                    <i class="mdi mdi-account-group me-2 text-success"></i>
                                                    <span class="fw-bold text-dark" style="font-size: 1.1rem;">{{ $division->users_count }}</span>
                                                    <span class="ms-2 text-muted small">orang</span>
                                                </div>
                                            @else
                                                <div class="personel-badge bg-secondary bg-opacity-10 border border-secondary border-opacity-25 rounded-3 px-3 py-2 d-inline-flex align-items-center">
                                    ...
                                    <td class="text-center">
                                        @if($division->users_count > 0)
                                            <span class="status-badge badge bg-success bg-opacity-25 text-success border border-success border-opacity-50 px-3 py-2 d-inline-flex align-items-center">
                                                <i class="mdi mdi-check-circle me-2"></i>
                                                <span class="fw-medium">Aktif</span>
                                            </span>
                                        @else
                                            <span class="status-badge badge bg-secondary bg-opacity-10 text-secondary px-3 py-2 d-inline-flex align-items-center">
                                    ...
                                    <td>
                                        <div class="date-wrapper">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="d-block fw-medium text-dark">{{ $division->created_at->translatedFormat('d M Y') }}</span>
                                                    <small class="text-muted">
