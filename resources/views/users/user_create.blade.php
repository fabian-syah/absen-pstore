...
@section('content')
    ...
    <form class="forms-sample" action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
        ...
        @php
            // Logic untuk menentukan apakah user yang login boleh edit cabang atau tidak
                ...
                <div class="card shadow-sm border-0 border-top border-3" style="border-top-color: #009688 !important;">
                    ...
                    <div class="card-body">
                         ...
                         <div class="alert alert-info border-0 rounded-3 mb-4 shadow-sm">
                            ...
                            Sistem akan otomatis mengkonversi ke waktu lokal cabang saat disimpan jika cabang memiliki zona waktu berbeda.
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3"><label class="form-label fw-bold">Jam Masuk (Check In)</label><input type="time" class="form-control form-control-lg" name="check_in_start" value="{{ old('check_in_start') }}"><small class="text-muted">Batas awal mulai absen masuk (WIB)</small></div>
                            <div class="col-md-6 mb-3"><label class="form-label fw-bold">Jam Pulang (Check Out)</label><input type="time" class="form-control form-control-lg" name="check_out_start" value="{{ old('check_out_start') }}"><small class="text-muted">Batas awal mulai absen pulang (WIB)</small></div>
                        </div>
