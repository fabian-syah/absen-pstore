        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card shadow-sm border-0 border-top border-3" style="border-top-color: #009688 !important;">
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-4"><i class="mdi mdi-information-outline me-1"></i>Atur jam masuk dan jam pulang spesifik untuk user ini. Biarkan kosong jika jadwal mengikuti shift umum atau fleksibel.</p>
                        <div class="row">
                            <div class="col-md-6 mb-3"><label class="form-label fw-bold">Jam Masuk (Check In)</label><input type="time" class="form-control form-control-lg" name="check_in_start" value="{{ old('check_in_start') }}"><small class="text-muted">Batas awal mulai absen masuk</small></div>
                            <div class="col-md-6 mb-3"><label class="form-label fw-bold">Jam Pulang (Check Out)</label><input type="time" class="form-control form-control-lg" name="check_out_start" value="{{ old('check_out_start') }}"><small class="text-muted">Batas awal mulai absen pulang</small></div>
                        </div>
