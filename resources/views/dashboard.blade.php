                                        ...
                                        <div class="text-center">
                                            ...
                                            @else
                                                ...
                                                <div class="cross-day-container"
                                                    ...
                                                    <form action="{{ route('manual-checkout') }}" method="POST" class="mt-3">
                                                        @csrf
                                                        <button type="submit" class="btn btn-outline-light btn-sm w-100"
                                                            onclick="return confirm('Apakah Anda yakin ingin absen pulang manual? (Hanya jika Anda benar-benar lupa absen pulang saat lembur kemarin)')"
                                                            style="border-radius: 10px; border-style: dashed; opacity: 0.9;">
