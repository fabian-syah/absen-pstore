...
<div class="row align-items-end mb-4">
    <div class="col-md-8 mb-3 mb-md-0">
        <h3 class="fw-bold text-dark mb-1">Manajemen Target</h3>
        <p class="text-muted mb-0">
            Monitor performa <span class="fw-bold text-primary">{{ auth()->user()->branch->name ?? 'Pusat' }}</span> dan Individu.
        </p>
    </div>
    <div class="col-md-4 text-md-end">
        <a href="{{ route('job-targets.create') }}" class="btn btn-primary btn-lg shadow-sm rounded-4 px-4 fw-bold w-100 w-md-auto">
            <i class="mdi mdi-plus-circle-outline me-1"></i> Buat Target
        </a>
    </div>
</div>
    ...
    <div class="card-header bg-white border-bottom py-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small class="text-muted">Prioritas tim dan riwayat keberhasilan</small>
            </div>
        </div>
    </div>
    ...
    <div class="card-header bg-gradient-info text-white border-bottom py-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small class="text-white opacity-75">Tanggung jawab dan prestasi personal</small>
            </div>
        </div>
    </div>
    <div class="card-body p-3 p-md-4">
